...
OUT_DIR = Path(r"C:/TMP/extra_fetch")
...
def main():
    ...
    print("Scanning extra story files...")
    ...
    print(f"Unresolved speaker names: {len(unresolved_names)}")
    ...
    with open(OUT_DIR / "extra_scan_stats.json", "w", encoding="utf-8") as f:
